...
News saturation is not a new phenomenon, but it has been more apparent since the 2016 US presidential election. It happens when a particular topic or story is disproportionately covered by the news media. This results in casual observers of the news no
...
I am building the web crawlers using a python web-crawling framework called scrapy. The R code is being stored on R Markdown files. 
