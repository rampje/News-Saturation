...
A big part of this research will be the collection of hourly news data from a variety of sources using [**News API**](https://newsapi.org/) and analyzing saturation topics. A shiny app will stream News API data to monitor the news in real time.

Another component of this research is observing daily changes in the news. The current strategy to capture this data is through the deployment of a web crawler targetting news sites and extracting news article data. This data is then filtered, processed, and further analyzed in R.
